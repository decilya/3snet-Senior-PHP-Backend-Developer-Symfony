...
**Решение:** Использовать композицию (реализовано в разделе 5 через `DeletionOrchestratorInterface` и `DeletionOrchestratorWrapper`).
...
## 5.2. Структура добавляемых файлов
